...
export default function AdminProblemsPage() {
  ...
  const fetchProblems = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/problems?limit=5000');
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage DSA problems for the platform
          </p>
        </div>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, topicTags: e.target.value })
                      }
                  ...
                  <div className="grid gap-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, mainTopics: e.target.value })
                      }
                      placeholder="arrays, hash-tables"
                    />
                  </div>

                  {/* Topic Slugs */}
                  <div className="grid gap-2">
                    <Label htmlFor="topicSlugs">
                      Topic Slugs (comma-separated)
                    </Label>
                    <Textarea
                      id="topicSlugs"
                      value={formData.topicSlugs}
                      onChange={(e) =>
                        setFormData({ ...formData, topicSlugs: e.target.value })
                      }
                      placeholder="array, hash-table, two-pointers"
                    />
                  </div>
